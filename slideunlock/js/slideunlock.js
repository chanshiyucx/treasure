...
function animateLeft(el, duration, left) {
  ...
  ;(function animation() {
    s.left =
      parseInt(s.left, 10) - step > 0 ? parseInt(s.left, 10) - step + 'px' : 0
...
function SliderUnlock(elm, options, success, always) {
  ...
  var opts = {
    labelTip:
      typeof options.labelTip !== 'undefined'
        ? options.labelTip
        : 'Slide to Unlock',
    successLabelTip:
      typeof options.successLabelTip !== 'undefined'
        ? options.successLabelTip
        : 'Success',
    duration:
      typeof options.duration !== 'undefined' || !isNaN(options.duration)
        ? options.duration
        : 200,
    swipestart:
      typeof options.swipestart !== 'undefined' ? options.swipestart : false,
    min:
      typeof options.min !== 'undefined' || !isNaN(options.min)
        ? options.min
        : 0,
    max:
      typeof options.max !== 'undefined' || !isNaN(options.max)
        ? options.max
        : $elm.clientWidth - $('.slideunlock-label')[0].clientWidth,
    index:
      typeof options.index !== 'undefined' || !isNaN(options.index)
        ? options.index
        : 0,
    IsOk: typeof options.isOk !== 'undefined' ? options.isOk : false,
    lableIndex:
      typeof options.lableIndex !== 'undefined' || !isNaN(options.lableIndex)
        ? options.lableIndex
        : 0
  }
...
SliderUnlock.prototype.reset = function() {
  ...
  animateOpacity($('.slideunlock-label-tip')[0], _self.opts.duration, 1)
...
SliderUnlock.prototype.backgroundTranslate = function() {
  ...
  $('.slideunlock-label-tip')[0].style.opacity =
    1 - parseInt($('.slideunlock-label')[0].style.left) / _self.max
}
...
SliderUnlock.prototype.updateView = function() {
  var _self = this,
    _labelTipEle = $('.slideunlock-label-tip')[0]
